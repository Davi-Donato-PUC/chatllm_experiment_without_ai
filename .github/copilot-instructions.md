...
1. **Read `README.md`** to understand the experiment's task structure (Task 1, Task 2, Socratic review).
...
3. **Determine the next pending step** and respond with one of the following templates:
   ...
   ### Task 1 pending
   > **Task 1 pending:** You must implement Task 1 — Login and Logout.
   >
   > **Requirements:**
   > - Email/password registration and login.
   > - Functional logout.
   > - Authentication data persisted in SQLite.
   >
   > **Note:** Check `README.md` to see whether this task is pipeline-controlled or free.

   ### Task 2 pending
   > **Task 2 pending:** You must implement Task 2 — Chat Sessions with Auto Title.
   >
   > **Requirements:**
   > - User can create and switch sessions through a sidebar (similar to ChatGPT and Gemini).
   > - Each session stores its history.
   > - If a session has no title yet, the title must be set automatically based on context (possibly as early as the model's first response).
   >
   > **Note:** Check `README.md` to see whether this task is pipeline-controlled or free.
